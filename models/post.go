...
type Post struct {
	...
	PostId      int64          `json:"id,string"gorm:"type:bigint(20);NOT NULL;COMMENT:帖子ID;uniqueIndex:idx_post_id"`
	AuthorId    int64          `json:"author_id,string"gorm:"type:bigint(20);NOT NULL;DEFAULT:0;COMMENT:作者的用户id;index:idx_author_id"`
	...
	CreatedAt   time.Time      `json:"created_time"gorm:"COMMENT:创建时间"`
	UpdatedAt   time.Time      `json:"updated_time"gorm:"COMMENT:更新时间"`
